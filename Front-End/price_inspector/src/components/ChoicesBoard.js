        ...
        return (
            <div className="p-6 bg-gray-100">
              <div className="flex w-2/3 m-auto mt-4 mb-4 justify-center items-center">
                <h1 className="text-center text-3xl text-gray-700 font-mono p-4 rounded border-b-2 border-gray-600">Inspector's Research</h1>
                ...
                <div className="flex">
                    <div className="flex flex-col w-1/2 items-center p-4">
                        <h2 className="text-2xl p-2 border-b-2 border-red-900 rounded font-mono shadow-xl mb-2">Select your Tickers</h2>
            ...
            <h2 className="text-2xl p-2 border-b-2 border-red-900 rounded font-mono shadow-xl mb-2">Results</h2>
            <div className="flex justify-center items-center h-full w-full m-2">
                ...
                <button onClick={this.onSubmitForm} className="flex justify-evenly bg-gray-800 rounded p-2 text-gray-100 w-1/4 m-auto font-mono text-xl cursor-pointer shadow-2xl ring-2 ring-gray-300 hover:bg-gray-200 hover:text-black hover:ring-gray-800 items-center focus:ring-green-700">Run the Inspector <span><DiYeoman className="w-8 h-8"/></span></button>
                </div>
            </div>
        );
    }
