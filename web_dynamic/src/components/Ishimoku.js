...
const IshimokuStrategy = () => {
	...
	return (
        ...
        {/*YOUR_FRONT_CCOMPONENT*/}
          	...
          	<button className="text-xl sm:text-3xl font-medium my-2 sm:my-5 hover:underline" onClick={handleClick}>ICHIMOKU</button>
					</div>
				</div>
        ...
        {/*YOUR_BACK_COMPONENT*/}
          	...
          	<button className="text-xl font-medium sm:text-3xl my-2 sm:my-5 hover:underline" onClick={handleClick}>ICHIMOKU</button>
