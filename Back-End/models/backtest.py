...
class Backtest(BaseModel, Base):
    ...
    param_1 = Column(Float, nullable=True, default=0)
    param_2 = Column(Float, nullable=True, default=0)
    param_3 = Column(Float, nullable=True, default=0)
    param_4 = Column(Float, nullable=True, default=0)
    param_5 = Column(Float, nullable=True, default=0)
    param_6 = Column(Float, nullable=True, default=0)
    param_7 = Column(Float, nullable=True, default=0)
    param_8 = Column(Float, nullable=True, default=0)
    param_9 = Column(Float, nullable=True, default=0)
