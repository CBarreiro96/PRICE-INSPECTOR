...
def Graph(Data):
    ...
    p.line(Data.loc[datetime(Año, Mes, Dia):datetime.now(), 'Date'],
           Data.loc[datetime(Año, Mes, Dia):datetime.now(), 'Price'], legend_label="Price.", line_color="blue",
           line_width=2)
    p.line(Data.loc[datetime(Año, Mes, Dia):datetime.now(), 'Date'],
    ...
    p.asterisk(x=Data[(Data['Buy'] == Dia)].loc[datetime(Año, Mes, Dia):datetime.now(), 'Date'],
               y=Data[(Data['Buy'] == Dia)].loc[datetime(Año, Mes, Dia):datetime.now(), 'Price'], size=20, color="green",
               line_width=Mes)
    p.asterisk(x=Data[(Data['Sell'] == Dia)].loc[datetime(Año, Mes, Dia):datetime.now(), 'Date'],
               y=Data[(Data['Sell'] == Dia)].loc[datetime(Año, Mes, Dia):datetime.now(), 'Price'], size=20, color="red",
               line_width=Mes)
